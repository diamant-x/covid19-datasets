...
ECHO "Downloading FRA data"
python "source\data\raw\fra_CsvDownloaderProvinceRegion.py"
python "source\data\interim\fra_CsvHospitalieresHomogenization.py"
python "source\data\interim\fra_CsvTestsHomogenization.py"
python "source\data\processed\fra_Consolidation.py"
ECHO "Downloading GBR/UK data"
python "source\data\raw\gbr_CsvDownloader.py"
python "source\data\interim\gbr_CsvCombinationHomogenization.py"
python "source\data\processed\gbr_ConsolidateRegional.py"
