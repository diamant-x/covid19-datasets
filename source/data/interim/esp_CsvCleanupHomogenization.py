...
namesOriginals = ["CCAA Codigo ISO","Fecha","Casos ","Hospitalizados","UCI","Fallecidos"]
namesColumns = ["Region","Date","Total confirmed cases", "Total Hospital cases", "Total ICU cases","Total deaths"]
